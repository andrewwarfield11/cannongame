...
public abstract class GameFrame extends JFrame implements Runnable {
		...
		addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				if(SwingUtilities.isLeftMouseButton(e))
					mouseLeftPress(e.getX(), e.getY());
				else if(SwingUtilities.isRightMouseButton(e))
					mouseRightPress(e.getX(), e.getY());
				else if(SwingUtilities.isMiddleMouseButton(e))
					mouseMiddlePress(e.getX(), e.getY());
			}
		});
	 ...
	 */
	protected abstract void keyPress(int e);
	

	/**
	 * This just gets called when a click occurs, no default behavior
	 */
	protected abstract void mouseLeftPress(int x, int y);
	
	protected abstract void mouseRightPress(int x, int y);
	
	protected abstract void mouseMiddlePress(int x, int y);
