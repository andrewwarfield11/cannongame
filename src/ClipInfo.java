...
public class ClipInfo implements LineListener
{
	...
	private void loadClip(String fnm)
	{
		try {
			...
			//URL sound = ClassLoader.getSystemResource("sounds/"+ fnm);
			//AudioInputStream stream = AudioSystem.getAudioInputStream(sound);
			// link an audio stream to the sound clip's file
			//InputStream is = getClass().getResource(fnm).openStream();
			
			//AudioInputStream stream = AudioSystem.getAudioInputStream(
					//new File(fnm) );
			AudioInputStream stream = AudioSystem.getAudioInputStream(getClass().getResource(new File(fnm).getName()));
	 ...
	 * @param toLoop boolean of whether it should loop
	 */
	...
	/**
	 * stops the clip and resets it to its start
	 */
	public void stop()
	...
	/**
	 * gets the name
	 * @return String the name of the clip
	 */
